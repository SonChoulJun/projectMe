...
<style type="text/css">
.modal-dialog.modal-fullsize { width: 135%; margin: 0; padding: 0; }
</style>
                ...
                <div class="active tab-pane" id="myTravel">
                  ...
                  <div class="box box-widget">
                    <div class="box-header with-border">
                      ...
                      <!-- /.user-block -->
                      <div class="box-tools" data-toggle="modal" data-target="#PhotosUpload">
...
<!--                         <button type="button" class="btn btn-box-tool"
  ...
  <div id ="PhotosUpload" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
          ...
          <div class="row">
            <div class="col-sm-8 col-sm-offset-2">
                ...
                <div class="wizard-navigation">
                  ...
                  <li>
                      <a href="#photoUplad" data-toggle="tab">
                        ...
                        photoUplad
                                  ...
                                  <li>
                      <a href="#photoFinish" data-toggle="tab">
                        <div class="icon-circle">
                          <i class="ti-panel"></i>
                        </div>
                        Finish
                                    ...
                                    <div id ="photoDiv" class="row">
                                      <div class="col-sm-12">
                                        ...
                                        <!-- Main content -->
                                          ...
                                          <div class="row">
                                               <input id="photoInputBt" type="file" class="file" multiple="true" >
                                          </div>
                                          <!-- /.row -->
                                        <!-- /.content -->
                                        ...
                                        <div class='pull-right'>
                                          <input id="inputPlusNext" type="hidden" class='btn btn-next btn-fill btn-success btn-wd' name='next' value='Next' />
                                        </div>
                            ...
                            <div class="wizard-footer">
                                <div class="pull-right">
                                      <input id="photoPlusFinish" type='button' class='btn btn-finish btn-fill btn-success btn-wd' name='finish' value='Finish' />
                  </div>
...
<!--                                   <div class="pull-left">
 ...
 <div id="photoSubUpload" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
			          ...
			          <div class="row">
			            <div class="col-sm-8 col-sm-offset-2" style="margin:0;">
			                ...
			                <div class="wizard-navigation">
			                  ...
			                  <li>
			                      <a href="#photoSubUplad" data-toggle="tab">
			                        <div class="icon-circle">
			                          <i class="ti-direction-alt"></i>
			                        </div>
			                        photoUplad
			                                  ...
			                                  <li>
			                      <a href="#photoSubFinish" data-toggle="tab">
			                        <div class="icon-circle">
			                          <i class="ti-panel"></i>
			                        </div>
			                        Finish
			                                    ...
			                                    <div id ="photoDiv" class="row">
			                                      <div class="col-sm-12">
			                                        ...
			                                        <!-- Main content -->
			                                          ...
			                                          <div class="row">
			                                               <input id="photoSubInputBt" type="file" class="file" multiple="true" >
			                                          </div>
			                                          <!-- /.row -->
			                                        <!-- /.content -->
			                                        ...
			                                        <div class='pull-right'>
			                                          <input id="inputSubNext" type="hidden" class='btn btn-next btn-fill btn-success btn-wd' name='next' value='Next' />
			                                        </div>
