...
<head>
  <script type="text/javascript"
    src="/html/assets/js/jquery.min.js"></script>
  ...
  function Locations() {  
      ...
      this.initMap = function () { 
          map = new google.maps.Map(document.getElementById('map'), {
            zoom: 7, 
            center: new google.maps.LatLng(36.496067, 128.127800),
      ...
      this.markerMaker = function(){
          var objthis = this;       
           ...
           for (i = 0; i <= locations.length; i++) {                   
                   ...
                   icon: image= {
                           url: '/html/assets/markertest/'+i+'.png',
                           radius:20000,
                           //borderRadius: 50,
             ...
             (function (map) {
                 google.maps.event.addListener(map, "click", function (e) {
                     ...
                     infoWindow.open(map, marker); */           
                     objthis.removeLine();
                     console.log("add전: " + objthis.getLength());
                     objthis.addLocations(e.latLng.lat(),e.latLng.lng());
                     console.log("add후: "+objthis.getLength());
                     objthis.removeLine();
                     objthis.markerRemove();
                     objthis.markerMaker();
                     objthis.flightPathMaker();
