...
<head>
  ...
  <link rel="apple-touch-icon" sizes="76x76" href="/html/photo/assets/img/apple-icon.png" />
  <link rel="icon" type="image/png" href="/html/photo/assets/img/favicon.png" />
...
<body>
  <div class="image-container set-full-height" style="background-image: url('/html/photo/assets/img/paper-2.jpeg')">
  ...
  <!--   Core JS Files   -->
  <script src="/html/photo/assets/js/jquery-2.2.4.min.js" type="text/javascript"></script>
  <script src="/html/photo/assets/js/bootstrap.min.js" type="text/javascript"></script>
