...
//=====================================================
	public static String toTrimStr(String str){
		if(str==null){
			return null;
		}
		else{
	...
	/*public static String toDateStrForDivyDate(String str){
		String dibyDate=CommonUtil.null2str(str);
		
		if(dibyDate.length()>0){
			return dibyDate.substring(0, 10).replace("-", "");
		}else{
			return dibyDate;
		}
	}*/
